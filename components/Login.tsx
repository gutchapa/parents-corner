    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-100 p-4 relative">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-stone-200">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-brand-600 rounded-full mx-auto flex items-center justify-center mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-stone-700 mb-1">Parent ID / Mobile</label>
            <input
              type="text"
              required
              value={username}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-brand-600 hover:bg-brand-700 text-white font-semibold py-3 rounded-lg transition-colors flex items-center justify-center"
          >
            {isLoading ? (
        ...
        <div className="mt-6 text-center text-xs">
          <div className="bg-brand-50 text-brand-800 p-2 rounded border border-brand-100 mb-3">
            <p className="font-semibold">Demo Mode</p>
            <p>You can enter any ID and Password to login.</p>
          </div>
          <p className="text-stone-400">Contact school administration if you forgot your credentials.</p>
        </div>
      </div>
